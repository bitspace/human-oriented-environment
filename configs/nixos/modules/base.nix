...

{
  ...
  boot = {
    ...
    # Kernel parameters optimized for ThinkPad P16 Gen 2
    kernelParams = [
      "intel_iommu=on"                    # Enable Intel IOMMU for virtualization
      "i915.enable_guc=3"                # Enable GuC and HuC for Intel graphics
      "processor.max_cstate=1"            # Optimize for performance over power
    ...
    # Enable Btrfs and other filesystems
  ...
  # Nix configuration optimized for performance and automation
  nix = {
    settings = {
      ...
      # Build settings optimized for 192GB RAM and 24-thread CPU
      max-jobs = "auto";
  ...
  # System-wide packages essential for LLM orchestration
  ...
  # Memory and performance optimizations for 192GB system
  boot.kernel.sysctl = {
